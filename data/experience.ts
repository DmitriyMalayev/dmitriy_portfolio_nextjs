...
export const experience: ExperienceItem[] = [
  {
    ...
    bullets: [
      ...
      'Engineered automated document ingestion pipelines that process inbound email (IMAP/OAuth) using Tesseract OCR, Apache Tika, and Gotenberg, with sender whitelisting, metadata extraction into custom fields, and rule-based classification by document type.',
  ...
  },
  {
    ...
    bullets: [
      'Engineered a client-facing sustainability portal using Kotlin/JS and React, enabling enterprise clients to track energy KPIs and manage more than 5,000 data points monthly.',
      ...
      'Increased application uptime to 99.8% and reduced data-related errors by 40% by architecting a new ELT/ETL testing pipeline and implementing robust data validation logic, while streamlining the development lifecycle with high-fidelity Figma mockups and Draw.io workflow diagrams, improving design handoffs and reducing rework.',
    ],
