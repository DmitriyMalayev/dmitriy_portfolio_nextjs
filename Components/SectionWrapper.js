...
const SectionWrapper = ({
  ...
  return (
    <section
      id={id}
      className="w-full lg:h-screen text-slate-300 py-12 mb-32"
    >
      <div className="flex flex-col justify-center items-center w-full h-full mx-auto">
        ...
        >
          ...
          >
            <div className={`text-3xl md:text-5xl font-bold inline border-b-4 border-orange-600 text-cyan-100 sm:px-2 pb-2 sm:mb-2 ${ text && 'sm:translate-x-1/2 lg:translate-x-0'}`}>
              {title}
            </div>
            <div
              className={`${
          ...
          {text && (
            <div className="sm:text-md lg:text-2xl leading-2 text-slate-50 p-3">
              <p className="pb-2 pt-3">{text}</p>
