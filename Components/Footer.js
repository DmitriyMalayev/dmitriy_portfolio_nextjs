const Footer = () => {
  return (
    <div className="text-xs md:text-md lg:text-lg sm:p-2 p-4 rounded-lg shadow flex items-center justify-between md:p-6 text-orange-700 gap-10 bg-orange-100/5 backdrop-blur-xl mt-20 ">
